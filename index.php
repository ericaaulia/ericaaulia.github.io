...
$q = mysqli_query($koneksi, "SELECT kode FROM tb_order_inventory order by kode desc limit 1");
...
if (isset($_POST['bsimpan'])) {
    ...
    if (isset($_GET['hal']) == "edit") {
        $edit = mysqli_query($koneksi, "UPDATE tb_order_inventory SET
        nama = '$_POST[tnama]',
     ...
     ");
        ...
        $simpan = mysqli_query($koneksi, " INSERT INTO tb_order_inventory (kode, nama, nm_penerima, asal, jumlah, satuan, tanggal_diterima)
                                   VALUE ( '$_POST[tkode]',
                                           '$_POST[tnama]', 
                                           '$_POST[tpenerima]',                                   
                                           '$_POST[tasal]',                                         
...
if (isset($_GET['hal'])) {
    ...
    if (isset($_GET['hal'])) {
        if ($_GET['hal'] == "edit") {
            $tampil = mysqli_query($koneksi, "SELECT * FROM tb_order_inventory WHERE id_barang = '$_GET[id]'");
        ...
        $hapus = mysqli_query($koneksi, "DELETE FROM tb_order_inventory WHERE id_barang = '$_GET[id]' ");
        if ($hapus) {
            echo "<script>
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    if (isset($_POST['bcari'])) {
                        ...
                        $keyword = $_POST['tcari'];
                        $q = "SELECT * FROM tb_order_inventory WHERE kode like '%$keyword%' or nama like '%$keyword%' or nm_penerima like '%$keyword%' or asal like '%$keyword%' order by id_barang desc  ";
                    } else {
                        $q = "SELECT * FROM tb_order_inventory order by id_barang desc";
                    }
